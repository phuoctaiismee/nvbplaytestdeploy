      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          {cartData?.items && cartData?.items?.length > 0 && (
            <p className="p-2 pt-1.5 size-[1.125rem] rounded-full text-white bg-red-500 absolute -top-1 -right-1 flex items-center justify-center text-[.625rem]">
